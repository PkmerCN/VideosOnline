package io.gitee.pkmer.promotions.enums.coupon;
...
public enum CouponScopeType implements BaseEnum<Integer> {
    ...
    public static CouponScopeType fromValue(Integer value) {
        return BaseEnumTemplate.fromIntValue(CouponScopeType.class, value);
    }
}
